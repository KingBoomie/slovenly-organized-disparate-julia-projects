...
# ╔═╡ 2e62d76a-6327-11ec-0edd-57f0872426e5
begin
...
# ╔═╡ fce33385-0abd-4121-8d81-6d4e97a39758
begin
...
# ╔═╡ 3e576724-3e33-42ba-85e3-2ca4c90acb0a
begin
...
# ╔═╡ 79ae3825-b75d-4d23-8eb1-22f45fed7e69
begin
...
# ╔═╡ 3fd90163-4b0e-46b9-88ad-a865fa67433a
begin
	final_time = 10.
	ts, qs, vs = simulate(state, final_time, simple_control!; Δt = 1e-3);
end

# ╔═╡ eb1646f4-1a87-47d9-8eca-f7ad7c009c5d
mvis = MechanismVisualizer(mechanism, URDFVisuals(urdf));

# ╔═╡ 0460d5f6-bef9-435c-ab11-2c51536a40f1
render(mvis)

# ╔═╡ 2fe58b53-e259-4a9e-8212-54cd39d0eb9a
...
[compat]
MeshCat = "~0.11.3"
MeshCatMechanisms = "~0.7.1"
RigidBodyDynamics = "~2.3.2"
RigidBodySim = "~1.3.0"
StaticArrays = "~0.12.5"
"""
...
git-tree-sha1 = "f465c8fb261367b2b6b01f9f30357df6bd658460"
...
[[deps.MechanismGeometries]]
deps = ["ColorTypes", "CoordinateTransformations", "GeometryTypes", "LightXML", "LinearAlgebra", "RigidBodyDynamics", "Rotations", "StaticArrays"]
git-tree-sha1 = "86ab29ff501fe86e41962efa33433768a706c447"
uuid = "931e9471-e8fb-5385-a477-07ad12718aca"
version = "0.5.0"

[[deps.MeshCat]]
deps = ["Base64", "BinDeps", "Blink", "Cassette", "Colors", "CoordinateTransformations", "DocStringExtensions", "FFMPEG", "GeometryTypes", "LinearAlgebra", "Logging", "MsgPack", "Mux", "Parameters", "Requires", "Rotations", "Sockets", "StaticArrays", "UUIDs", "WebSockets"]
git-tree-sha1 = "4ec09b64e9477aa0c8e82a5189a12d3dddd65faf"
uuid = "283c5d60-a78f-5afe-a0af-af636b173e11"
version = "0.11.3"

[[deps.MeshCatMechanisms]]
deps = ["ColorTypes", "CoordinateTransformations", "GeometryTypes", "InteractBase", "Interpolations", "LoopThrottle", "MechanismGeometries", "MeshCat", "Mux", "OrderedCollections", "RigidBodyDynamics"]
git-tree-sha1 = "cbbbd5b996096c5e3bbe38bd01fca9816bc566b8"
