...
# ╔═╡ 301cb178-154f-11ec-2115-e12430e758a9
begin
	using CairoMakie
	using DataFrames
...
# ╔═╡ e427b9d5-f788-4b8d-b2de-659d689dac20
...
# ╔═╡ 49a9b7eb-b675-4629-ac73-bbdd006bc1e0
fail = DataFrame(cat=data_fail[1], name=data_fail[2], value=data_fail[3])

# ╔═╡ 797eb05d-bea3-4d31-8d44-2ae1e88ab5d2
...
# ╔═╡ 0bcf3dbd-eac4-4cfb-883a-37401ce69ea4
not_fail = fail[1:7,:]

# ╔═╡ 5e6a0c5e-6799-4cc8-bd98-4c480e8428cf
