...
# ╔═╡ a9716630-6e9b-11ed-01bf-21fb4d67c54f
begin
	using DSP
	using FFTW
...
# ╔═╡ 9f3f205a-5593-47db-84eb-6522ab93c7c1
gr()

# ╔═╡ a950ced9-04c0-437f-bf06-b555bb1e8a8c
TableOfContents()

# ╔═╡ 43323d20-4b3c-4bc6-a950-75b6a97629c8
dt = 1/240000

# ╔═╡ e22f5f6e-1b66-47a3-97da-a3d88db76c31
hamming(i,n) = 0.54 - 0.46 * cos(2π*i/n)

# ╔═╡ ef91e979-8f49-47b6-aab4-2c36ee0b9662
low_pass(cutoff, x, n) = 2cutoff/x * sin(2π*(im-n/2)*cutoff/x)/(2π*(im-n/2)*cutoff/x)*hamming(n)

# ╔═╡ 2b917aa0-cb85-47be-b054-0de7efa5fa0b
plot(0:0.01:3, hamming.(0:0.01:3, ))

# ╔═╡ 982ee3ed-5032-4f56-8aa7-c6ff41f6401a
hamming.(0:0.01:3)

# ╔═╡ 3ad2fc80-f958-4b67-aa9c-12e0217f7a6e
md"# Util"

# ╔═╡ d1e50ea9-09b8-46f0-9864-f88e781d17bf
function load_iq(fn)
...
# ╔═╡ 9f69adb7-2d10-44a0-a330-9c050dee8c33
iq = load_iq("dsp-assets/iq-fm-96M-240k.dat")

# ╔═╡ 1077186a-f9d9-4f46-99f8-2e12e8e6fd28
test = iq[1:100]

# ╔═╡ 2557dc09-3bc1-47b1-97e9-26a5c37e0f9f
plot(abs.(test))

# ╔═╡ 4b5188a2-80c3-4664-87c0-b056bcf1e5e7
plot(test)

# ╔═╡ b9a7af17-3c96-466f-a24b-13f7871e5c14
fftt = fft(test) 

# ╔═╡ e3783122-136c-43eb-be8c-f41d92ac3cca
plot(abs.(fftt))

# ╔═╡ cf550e90-1969-48ac-bc21-f968eeb9fc93
z = angle.(iq[1:end-1] ./ iq[2:end])

# ╔═╡ 11b978bb-4b44-49df-b66d-f1d75667148e
s = z ./ dt

# ╔═╡ 3f0d61cc-a41a-49a0-b8d0-64130d9415a2
low_pass.(15e3, z, 20)

# ╔═╡ 33172b16-b66c-4ecb-b63b-a1573eab3e03
...
julia_version = "1.8.3"
manifest_format = "2.0"
project_hash = "15821dea862df4b50cfb03a07ab431b16727260d"
