...
# ╔═╡ 23166e44-7d0f-11ec-2d62-fbba488bf0ab
begin
	using Fatou
	using PyPlot
	using PlutoUI
...
# ╔═╡ 2fffcfcf-595e-4513-bd70-f8a39b7a2f0c
PyPlot.svg(true)

# ╔═╡ 83f53195-59fc-4501-8869-509aa86f265c
@bind p Slider(2:2:12, show_value=true)

# ╔═╡ c008845d-4321-492c-a823-72cffa1ad32e
@bind cr Slider(-1:0.01:1, default=-0.15)

# ╔═╡ af89220a-1ce5-4895-ae68-35855452ac11
@bind ci Slider(-1:0.01:1, default=-0.71)

# ╔═╡ ec556211-237a-4ee2-80bb-da0c7d784efe
c = cr + ci*im

# ╔═╡ 2d41d2be-0c90-4090-babe-7aae49783986
nf = juliafill(:( cos(z^2)+$c),n=2400,N=40,cmap="inferno", ∂=[-1.5,1.5,-1,1])

# ╔═╡ b31c22e3-bfb0-4e3b-bca6-c72e412dad11
let
	clf()
	figure = plot(fatou(nf), bare=true)
	gcf()
end

# ╔═╡ 1e6163c9-9ef0-4a42-8c67-d68c9a9871ce
heatmap(fatou(nf).mix, resolution=(1600, 1600))

# ╔═╡ 00000000-0000-0000-0000-000000000001
PLUTO_PROJECT_TOML_CONTENTS = """
[deps]
CairoMakie = "13f3f980-e62b-5c42-98c6-ff1f3baf88f0"
Fatou = "5f923234-c850-556d-bb4f-28324fa1959a"
...
deps = ["AbstractLattices", "LinearAlgebra", "Random"]
git-tree-sha1 = "2e2dc50d12a8a0c0a0aba63a4d76aeebfcf710de"
...
[[deps.Fatou]]
deps = ["ColorSchemes", "LaTeXStrings", "Reduce", "Requires", "SyntaxTree"]
git-tree-sha1 = "0ab698df97e46f4465d70a4a401f7e6b708bbbf2"
...
git-tree-sha1 = "decab29ece048b8808391025b8c423530646e792"
