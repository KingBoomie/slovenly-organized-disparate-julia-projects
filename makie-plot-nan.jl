...
# ╔═╡ 6e812146-fe2b-11ed-3023-e33f2d7deb7b
begin
...
# ╔═╡ 18dd7dbb-6c4c-4dc7-9e92-f18c7d46ea4e
let
	a = sqrt.(abs.(randn(1000)))
	b = a .* 0.5 .+ randn() / 10
	c = b .* 0.5 .+ randn() / 20
...
# ╔═╡ f8add588-9031-4d25-b11c-6f94453fe3a3
begin
	a = sqrt.(abs.(randn(1000)))
	b = a .* 0.5 .+ randn() / 10
	c = b .* 0.5 .+ randn() / 20
	...
	# adding nans separates the lines
	nans = fill(NaN, size(a))

	data = hcat(a, b, c, nans)

	@cast flat[(j,i)] := data[i,j]
	ixs = repeat([1,2,3,NaN],1000)
	
	lines!(ax, ixs, flat; color = colorant="0x1000")
	f
end

# ╔═╡ 27eb15f1-e90f-4c4e-96b3-0503e35fb650
a

# ╔═╡ a3dbdf3c-9a6b-495e-82bf-5a45048574f9
b

# ╔═╡ 453cf7e7-e23f-4c2d-8de7-5ba3f852c8ef
flat
...
julia_version = "1.9.0"
manifest_format = "2.0"
project_hash = "a9af4c8aa99530c13f85334d9e28a1457a6e25ef"
