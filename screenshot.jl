...
# ╔═╡ cf8b6a18-2799-11ec-026a-c5d858e1ce1d
begin
	using FileIO
	using ImageIO
	using ImageShow
...
# ╔═╡ ce671147-700a-43a2-b184-69a304db5001
read(`xwininfo`, String) |> Text

# ╔═╡ 2386fe37-2342-4cfd-9077-e6f22495fcce
window_id = "0x9400003"

# ╔═╡ 19ff9e63-c46e-45d5-b1ff-331a0442ae57
cmd = `import -window $window_id png:-`

# ╔═╡ aac40687-e4db-43bd-97fc-7ee1e118fc25
io = read(cmd)

# ╔═╡ 5ab6e1e7-a437-441a-be85-25209a3e5590
img2 = load(IOBuffer(io))
